...
const Footer = () => {
  return (
    <section class="pt-4 sm:pt-10 lg:pt-12">
    <footer class="max-w-screen-2xl px-4 md:px-8 mx-auto">
      <div class="flex flex-col md:flex-row justify-between items-center border-t border-b gap-4 py-6">
        <div class="flex flex-wrap justify-center md:justify-start gap-x-4 gap-y-2 md:gap-6">
      ...
      <div class="text-gray-400 text-sm text-start py-8">© 2021 - Present Flowrift. All rights reserved.</div>
    </footer>
  </section>
  )
}
